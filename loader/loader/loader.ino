...
const char LOADER_VERSION[] = "1.2.6";
    ...
    if (error && error != 0xD87A) {
      ...
      switch (error) {
        ...
        case 2:
          ...
          gb.display.println("RAM OVERFLOW?");
          gb.display.println("MEMORY ALIGNMENT?");
          gb.display.println("UNDEFINED INSTRUC?");
          gb.display.println("EXEC XN ADDRESS?");
          break;
        case 3:
          gb.display.println("WATCHDOG RESET\n");
          gb.display.println("DID YOU PUT\ngb.begin() FIRST\nIN setup()?");
          break;
        case 4:
          gb.display.println("INVALID PROGRAM\n");
          gb.display.println("DID YOU COMPILE FOR\nGAMEBUINO META?");
          break;
        default:
      ...
      while (1) {
        while (!gb.update());
        gb.display.setCursor(0,gb.display.height() - gb.display.fontHeight);
